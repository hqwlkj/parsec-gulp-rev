...
Outlined below are two common approaches to integrating an asset manifest like the one **parsec-gulp-rev** outputs into an application.

For our examples, we'll assume the following `rev-manifest.json`:

```json
{
	"js/app.js": "js/app.js?v=5c41412f32",
	"js/lib.js": "js/lib.js?v=6d94673e3d",
	"css/app.css": "css/app.css?v=a4ae3dfa4d"
}
````
