# parsec-gulp-rev [![Gitter](https://badges.gitter.im/join_chat.svg)](https://gitter.im/hqwlkj/parsec-gulp-rev)
...
This plugin does not support streaming. If you have files from a streaming source, such as browserify, you should use [gulp-buffer](https://github.com/jeromew/gulp-buffer) before `parsec-gulp-rev` in your pipeline:
...
For more info on how to integrate **parsec-gulp-rev** into your app, have a look at the [integration guide](integration.md).


## Works with parsec-gulp-rev
...
- [parsec-gulp-rev-collector](https://github.com/hqwlkj/parsec-gulp-rev-collector) - Static asset revision data collector
